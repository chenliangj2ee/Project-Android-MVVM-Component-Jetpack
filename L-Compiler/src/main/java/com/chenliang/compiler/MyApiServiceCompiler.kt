...
//            return false
        ...
        mApiServices?.forEach {
            ...
            var name = anno.mName.substring(0, 1).toUpperCase()+anno.mName.substring(1).toLowerCase()
            var path = anno.mPath
            ...
            var myApiFactory = TypeSpec.objectBuilder("My${name}Factory")
            println(
...
//            com.chenliang.account.ApiService
            ...
            var codeBlock = CodeBlock.builder()
                .addStatement(
                    ...
                    ClassName("com.mtjk.utils", "initAPI"),
                    devPath,
            ...
            val square = PropertySpec.builder(name.toUpperCase(), ClassName(apiPackageName, apiName))
                .receiver(Any::class)
                .setter(
                ...
                .getter(
                    FunSpec.getterBuilder()
                        .addStatement("return My${name}Factory.api!!")
                        .build()
                ).mutable(true)
                .build()
