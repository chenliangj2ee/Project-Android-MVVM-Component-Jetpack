...
//        // 设置头像圆角
        messageRecyclerView.setAvatarRadius(19);
//        // 设置头像大小
        messageRecyclerView.setAvatarSize(new int[]{38, 38});
//
//        ////// 设置昵称样式（对方与自己的样式保持一致）//////
...
//        // 设置自己聊天气泡的背景
        //tag==气泡右边
        messageRecyclerView.setRightBubble(mContext.getResources().getDrawable(R.drawable.icon_chatpao_reght));

//        // 设置朋友聊天气泡的背景
//        messageRecyclerView.setLeftBubble(new ColorDrawable(0xFFE4E7EB));
        //tag==气泡左边
        messageRecyclerView.setLeftBubble(mContext.getResources().getDrawable(R.drawable.icon_chatpao_left));
//
//        ////// 设置聊天内容 //////
//        // 设置聊天内容字体字体大小，朋友和自己用一种字体大小
//        messageRecyclerView.setChatContextFontSize(15);
//        // 设置自己聊天内容字体颜色
        messageRecyclerView.setRightChatContentFontColor(0xFFFFFFFF);
//        // 设置朋友聊天内容字体颜色
...
//        inputView.disableCaptureAction(true);
        inputView.disableSendFileAction(true);//隐藏发送文件
//        inputView.disableSendPhotoAction(true);
        inputView.disableVideoRecordAction(true);//隐藏摄像


        // TODO 可以自己增加一些功能，可以打开下面代码测试
        // 预约按钮
//        InputMoreActionUnit unit = new InputMoreActionUnit() {};
//        unit.setIconResId(R.drawable.icon_more_order);
...
//            inputView.addAction(unit);//隐藏自定义的更多图像
//        }
