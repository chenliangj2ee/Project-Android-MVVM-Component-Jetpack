...
public class ChatView extends LinearLayout implements IChatLayout, View.OnClickListener {
    ...
    private Button chatNoticeStart;
    private LinearLayout chatNoticeView;
    private ImageView chatNoticeClose;
    private TextView chatNoticeTime;
    ...
    private void initViews() {
        ...
        chatNoticeStart = findViewById(R.id.chat_notice_start);
        chatNoticeView = findViewById(R.id.chat_notice_view);
        chatNoticeClose = findViewById(R.id.chat_notice_close);
        chatNoticeClose.setOnClickListener(this);
        chatNoticeTime = findViewById(R.id.chat_notice_time);
    ...
    @Override
    public void onClick(View v) {
        if (v.getId() == R.id.chat_notice_close) {
            chatNoticeView.setVisibility(GONE );
        }
    }
