...
//        finish();
    ...
    private ChatInfo getChatInfo(Intent intent) {
        ...
        String id = intent.getStringExtra(TUIConstants.TUIChat.CHAT_ID) != null ? intent.getStringExtra(TUIConstants.TUIChat.CHAT_ID) : intent.getExtras().getString(TUIConstants.TUIChat.CHAT_ID);
        String name = intent.getStringExtra(TUIConstants.TUIChat.CHAT_NAME) != null ? intent.getStringExtra(TUIConstants.TUIChat.CHAT_NAME) : intent.getExtras().getString(TUIConstants.TUIChat.CHAT_NAME);
        MyFunctionKt.log(this, "id:" + id + "   name:" + name);
        chatInfo.setId(id);
