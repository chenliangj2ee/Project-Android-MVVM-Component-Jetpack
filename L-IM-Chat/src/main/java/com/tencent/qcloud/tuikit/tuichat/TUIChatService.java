...
public class TUIChatService extends ServiceInitializer implements ITUIChatService {
    ...
    public void init(Context context) {
        MyFunctionKt.log(this, "IM TUIChatService 初始化...................");
        instance = this;
        appContext = context;
    ...
    private void initIMListener() {
        MyFunctionKt.log(this, "腾讯IM注册事件监听.......");
        V2TIMManager.getMessageManager().addAdvancedMsgListener(new V2TIMAdvancedMsgListener() {
            @Override
            public void onRecvNewMessage(V2TIMMessage msg) {
                //tag==收到消息
                MyFunctionKt.log(this, "收到消息......" + new Gson().toJson(msg));

                if (TextUtils.isEmpty(msg.getGroupID())) {
                    MyFunctionKt.messageNotification(this, msg.getUserID() + "", msg.getNickName() + "", "你有新消息了");
                } else {
                    MyFunctionKt.messageNotification(this, msg.getGroupID() + "", msg.getNickName() + "", "你有新消息了");
                }
