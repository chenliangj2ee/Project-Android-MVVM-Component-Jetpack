...
public class VideoChatViewActivity extends AppCompatActivity {
    ...
    private final IRtcEngineEventHandler mRtcEventHandler = new IRtcEngineEventHandler() {
        ...
        public void onJoinChannelSuccess(String channel, final int uid, int elapsed) {
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    Log.i("VideoChatViewActivity","Join channel success, uid: " + (uid & 0xFFFFFFFFL));
                }
            });
        }
        ...
        public void onUserJoined(final int uid, int elapsed) {
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    Log.i("VideoChatViewActivity","First remote video decoded, uid: " + (uid & 0xFFFFFFFFL));
        ...
        public void onUserOffline(final int uid, int reason) {
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    Log.i("VideoChatViewActivity","User offline, uid: " + (uid & 0xFFFFFFFFL));
    ...
    private void showSampleLogs() {
        ...
        Log.e("VideoChatViewActivity","You can also use this to show errors");
    }
    ...
    private void joinChannel() {
        ...
        mRtcEngine.joinChannel("0065d170d0bcea844b58f04b68c20dcd675IACqG3O5BB+1Bu3LcFGsdem/2RC71J13ohit6CpM6GdFd+IVUyEAAAAAEACA5jcRhFHyYQEAAQCDUfJh",
                "demoChannel1", "Extra Optional Data", 0);
    }
