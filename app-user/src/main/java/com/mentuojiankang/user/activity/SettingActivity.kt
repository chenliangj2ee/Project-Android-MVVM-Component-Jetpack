...
import com.mentuojiankang.user.databinding.ActivitySettingBinding
...
class SettingActivity : MyBaseActivity<ActivitySettingBinding, DefaultViewModel>() {
    ...
    override fun initClick() {
        ...
        with(mBinding) {
            ...
            about.goto(WebViewActivity::class.java, "url", "file:///android_asset/html/user_about.html", "title", "关于吱吱")
