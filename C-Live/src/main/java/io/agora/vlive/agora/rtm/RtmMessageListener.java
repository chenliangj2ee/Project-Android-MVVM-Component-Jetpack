...
public interface RtmMessageListener {
    ...
    void onRtmMemberJoined(String userId);
    void onRtmMemberExitRoom(String userId);
    void onRtmMemberLeft(RtmChannelMember rtmChannelMember);

    void onRtmSeatInvited(String userId, String userName, int index);
    void onCancelRtmSeatInvited();
    void onRtmSeatApplied(String userId, int uid, String userName, String avatar, int index);

    void onCancelLinked(String userId, int uid, String userName, String avatar, int index);
    ...
    void onAnchorUidResponse(int uid,List<SeatStateMessage.SeatStateMessageDataItem> seats);
