...
public class UpTriangleView extends View {
    private static final int VIEW_COLOR = Color.parseColor("#008599");
    ...
    private void initShape() {
        mStrokeWidth = getContext().getResources().getDimensionPixelSize(
                R.dimen.live_host_in_seat_item_dialog_stroke_width);
