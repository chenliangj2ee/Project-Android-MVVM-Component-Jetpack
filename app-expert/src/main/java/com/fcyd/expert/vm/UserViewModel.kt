...
class UserViewModel : MyBaseViewModel() {
    ...
    fun inApp(bean: BeanAuth) = go {
        ...
        var body = body(
            ...
            body(
                "data",
                if (bean.gajl_zmzl == 0) bean.gajl_images.joinToString(separator = ",") { i -> i } else bean.gajl_text,
                "dataType",
                bean.gajl_zmzl,
                "duration",
                bean.gajl_sc!!,
                "type",
                1,//1-个案，2-个人体验经历，3-个体督导经历，4-团体督导，5-短程-经历，6-长程-经历
            ),
            ...
            body(
                "data",
                if (bean.ttddjl_zmzl == 0) bean.ttddjl_images.joinToString(separator = ",") { i -> i } else bean.ttddjl_text,
                "dataType",
                bean.ttddjl_zmzl,
                "duration",
                bean.ttddjl_sc!!,
                "type",
                4,//1-个案，2-个人体验经历，3-个体督导经历，4-团体督导，5-短程-经历，6-长程-经历
            ),
            "individualSupervision",
            body(
                "data",
                if (bean.gtddjl_zmzl == 0) bean.gtddjl_images.joinToString(separator = ",") { i -> i } else bean.gtddjl_text,
                "dataType",
                bean.gtddjl_zmzl,
                "duration",
                bean.gtddjl_sc!!,
                "type",
                3,//1-个案，2-个人体验经历，3-个体督导经历，4-团体督导，5-短程-经历，6-长程-经历
            ),
            "longTraining",
            body(
                "data",
                if (bean.ccsxjl_zmzl == 0) bean.ccsxjl_images.joinToString(separator = ",") { i -> i } else bean.ccsxjl_text,
                "dataType",
                bean.ccsxjl_zmzl,
                "duration",
                bean.ccsxjl_sc!!,
                "type",
                6,//1-个案，2-个人体验经历，3-个体督导经历，4-团体督导，5-短程-经历，6-长程-经历
            ),
            "personalExperience",
            body(
                "data",
                if (bean.grtyjl_zmzl == 0) bean.grtyjl_images.joinToString(separator = ",") { i -> i } else bean.grtyjl_text,
                "dataType",
                bean.grtyjl_zmzl,
                "duration",
                bean.grtyjl_sc!!,
                "type",
                2,//1-个案，2-个人体验经历，3-个体督导经历，4-团体督导，5-短程-经历，6-长程-经历
            ),
            "shortTraining",
            body(
                "data",
                if (bean.dcsxjl_zmzl == 0) bean.dcsxjl_images.joinToString(separator = ",") { i -> i } else bean.dcsxjl_text,
                "dataType",
                bean.dcsxjl_zmzl,
                "duration",
                bean.dcsxjl_sc!!,
                "type",
                5,//1-个案，2-个人体验经历，3-个体督导经历，4-团体督导，5-短程-经历，6-长程-经历
            ),
        )
    ...
    fun getIMRTCToken(channelName: String, userId: String) =
        go { API.getRTCToken(body("channelName", channelName, "userId", userId)) }
